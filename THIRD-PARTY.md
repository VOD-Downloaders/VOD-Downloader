...
This project uses a lot of third-party crates and libraries, they are listed below:

## Rust

Below are the crates used in this project:
...
| [serde_qs](https://crates.io/crates/serde_qs) | 0.2 | MIT / Apache-2.0 | Url encoding and decoding |
...
Below are dependencies for [`web`](./web):

| Library | Version| License | Purpose |
|---|---|---|---|
| [Bootstrap](https://getbootstrap.com/) | 5.3.8 | MIT | Simplify web dev with templates |
